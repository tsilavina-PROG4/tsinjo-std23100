...
import static com.tsinjo.app.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.tsinjo.app.PojaGenerated;
import com.tsinjo.app.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.tsinjo.app.event1";
    return "com.tsinjo.app.event2";
  }
}
